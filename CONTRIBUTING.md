...
| `npm run test:electron` | Production Electron specs under `tests/e2e/electron/` |
...
- **Browser `tests/e2e/**/*.spec.js`**, excluding `tests/e2e/electron/**`,
  → **Playwright** (`playwright.config.js`); this includes `tests/e2e/**/*.spec.js` and
  `tests/e2e/integration/**/*.spec.js`.
- **`tests/e2e/electron/**/*.spec.js`** → the dedicated production-Electron Playwright
