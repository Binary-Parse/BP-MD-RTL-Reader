...
test.describe('[Adversarial-B] CSS logical-property geometry in RTL mode', () => {
  ...
  test('[B2] blockquote accent border is on the correct (inline-start) side in RTL', async ({ page }) => {
    ...
    // So borderRightWidth should be '2px' and borderLeftWidth should be '0px'
    // v10 redesign (2026-08-25): blockquote border 3px accent -> 2px gold.
    expect(borderInfo.borderRightWidth).toBe('2px');
